...
typedef void(^YXWriteValueViewGetListBlock)(NSString *saveName, NSString *downAmount, NSString *downName, NSString *saveBegainNum, NSString *downAddress, NSString *downAddressBefore, NSString *downAddressAfter, BOOL boolNeedNumMakeUp);
...
/** 数字前缀 */
@property (weak, nonatomic) IBOutlet UITextField *downLoadAddressBefore;
/** 数字后缀 */
@property (weak, nonatomic) IBOutlet UITextField *downLoadAddressAfter;
/** 是否需要数字补足 */
@property (weak, nonatomic) IBOutlet UISwitch *boolNeedNumToMakeUp;
